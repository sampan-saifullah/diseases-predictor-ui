...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Specialist", value: "specalist.name", width: "10%" },
      { text: "Symptoms", value: "symptoms", width: "60%" },
  ...
  methods: {
    ...
    symptoms() {
      this.$axios.get("/symptom").then((r) => {
        this.symptomsItems = r.data;
      });
    },
    initialize() {
      this.$axios
    ...
    async deleteItemConfirm() {
      await this.$axios.delete(`/diseases/${this.editedItem._id}`);
      this.closeDelete();
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        this.$axios
          .post(`/diseases/${this.editedItem._id}`, {
            name: this.editedItem.name,
            symptoms: this.editedItem.symptoms,
